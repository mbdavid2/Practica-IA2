...
([ontologia_Class100003] of  Especialidad
	...
	(idioma Castellano)
	(nivelCompetencia N1)
	(nombreAsig "Diseño de Bases de Datos")
...
([ontologia_Class10020] of  Obligatoria
	...
	(idioma Castellano Catalan)
	(nivelCompetencia N1)
	(nombreAsig "Empresa y Entorno Económico")
	(promedioAprobados 99.0)
	(proyecto FALSE)
	(siglas "EEE")
	(temas
...
([ontologia_Class20000] of  Especializado
	...
	(nombreTema "Diseño de sistemas web"))

([ontologia_Class20001] of  Especializado

	(asignaturas [ontologia_Class10017])
	(nombreTema "Diseño UML"))
...
([ontologia_Class30005] of  Especializado
	...
	(nombreTema "Diseñador de bases de datos"))
...
([ontologia_Class30014] of  Especializado
	...
	(asignaturas [ontologia_Class77])
	(nombreTema "Procesamiento de Señal"))
...
([ontologia_Class40000] of  Especialidad
	...
	(idioma Catalan)
	(nivelCompetencia N3)
	(nombreAsig "Proyecto Ingeniería Software")
	(nombreEsp IngenieriaSoftware)
	(obligatoria Obligatoria)
	(prerequisitos
...
([ontologia_Class40002] of  Especialidad
	...
	(idioma Castellano Catalan)
	(nivelCompetencia N3)
	(nombreAsig "Tecnologías Redes Computadores")
	(nombreEsp TecnologiasInformacion)
	(obligatoria Obligatoria)
	(prerequisitos [ontologia_Class10019])
...
([ontologia_Class50001] of  Especialidad
	...
	(idioma Castellano Catalan)
	(nivelCompetencia N2)
	(nombreAsig "Diseño Sistemas Basados Microcomputadores")
	(nombreEsp IngenieriaComputadores)
	(obligatoria Obligatoria)
...
([ontologia_Class50002] of  Especialidad
	...
	(idioma Castellano Catalan)
	(nivelCompetencia N3)
	(nombreAsig "Programación Consciente Arquitectura")
	(nombreEsp IngenieriaComputadores)
	(obligatoria Complementaria)
	(prerequisitos [ontologia_Class10018])
	(promedioAprobados 60.0)
...
([ontologia_Class50003] of  Especialidad
	...
	(idioma Castellano Catalan)
	(nivelCompetencia N3)
	(nombreAsig "Seguridad Informática")
	(nombreEsp TecnologiasInformacion)
	(obligatoria Obligatoria)
	(promedioAprobados 60.0)
	(proyecto FALSE)
...
([ontologia_Class50004] of  Especialidad
	...
	(idioma Castellano Catalan)
	(nivelCompetencia N3)
	(nombreAsig "Negocio Electrónico")
...
([ontologia_Class50005] of  Especialidad
	...
	(idioma Castellano Catalan)
	(nivelCompetencia N3)
	(nombreAsig "Sistemas Información Organizaciones")
	(nombreEsp SistemasInformacion)
	(obligatoria Obligatoria)
	(prerequisitos
		[ontologia_Class91]
...
([ontologia_Class50006] of  Especialidad
	...
	(idioma Castellano Catalan)
	(nivelCompetencia N1)
	(nombreAsig "Administración Bases Datos")
	(nombreEsp SistemasInformacion)
	(obligatoria Complementaria)
	(prerequisitos [ontologia_Class91])
...
([ontologia_Class50010] of  Optativa
	...
	(idioma Ingles)
	(nivelCompetencia N1)
	(nombreAsig "Física Orientada a la Modelización y la Animación Realista")
...
([ontologia_Class50013] of  Optativa
	...
	(idioma Catalan)
	(nivelCompetencia N3)
	(nombreAsig "Visión por computador")
	(promedioAprobados 60.0)
	(proyecto TRUE)
	(siglas "VC")
	(temas [ontologia_Class101]))
...
([ontologia_Class60001] of  Optativa
	...
	(idioma Castellano)
	(nivelCompetencia N2)
	(nombreAsig "Tarjetas Gráficas y Aceleradores")
	(promedioAprobados 80.0)
	(proyecto TRUE)
	(siglas "TGA")
	(temas
...
([ontologia_Class97] of  Obligatoria
	...
	(idioma Castellano Catalan)
	(nivelCompetencia N3)
	(nombreAsig "Interaccion y Diseño de Interficies")
	(prerequisitos
		[ontologia_Class93]
		[ontologia_Class90])
	(promedioAprobados 75.0)
